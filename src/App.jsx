    ...
    <div className="w-screen overflow-hidden flex flex-col">
      ...
      <section className="h-[50vh] md:h-[70vh] font-Poppins relative flex justify-center flex-col items-center  bg-[#22112b] w-full">
        <div className="h-full absolute opacity-20 w-full">
          <img
            className="object-cover h-full md:object-contain  w-full"
            src={img}
            alt=""
          />
        </div>
        <div className="intro flex justify-center flex-col items-center ">
          ...
          <h1 className="text-[3.5rem] md:text-[6rem] z-20 font-bold text-white">
            Eyob Betemariam
          </h1>
          <h1 className="font-[800] text-[2rem] z-20 text-white">
            <span className="font-[800] text-[3rem] z-20 text-blue-300 md:text-[5rem]">
              junior Full-Stack
            </span>{" "}
            developer
          </h1>
      ...
      <section id="about" className="font-Poppins md:px-80  px-16">
        <p className="text-[1.8rem]  md:text-[2.3rem] md:mt-32 mt-16">
          ...
          Node.js) and good experience in Laravel. With a strong foundation in
          building dynamic, user-friendly, and scalable web applications, I
          possess a deep understanding of both front-end and back-end
      ...
      <section
        id="experiances"
        className="px-10 font-Poppins text-[2.6rem] flex flex-col gap-7"
      >
        <h1 className=" text-center pt-20 text-[3rem] font-[800]">
          My Experiace
        </h1>
        <div className="flex px-10 md:px-80 py-5 shadow-sm   gap-5 justify-center text-[8rem] flex-wrap">
          <div>
            ...
            <p className="text-[1.6rem]  md:pr-80">
              During my time at Micro Sun and Solution PLC, I collaborated on a
              job-portal mobile application project. My primary responsibility
              was building the API using Laravel. This experience was
              invaluable, as it allowed me to enhance my technical skills and
              gain a deeper understanding of time management and project flow.{" "}
            </p>
          </div>
        </div>
        <div className="flex px-10 md:px-80 py-5 shadow-sm   gap-5 justify-center text-[8rem] flex-wrap">
          <div>
            ...
            <p className="text-[1.6rem]  md:pr-80">
              I have completed four solid stages and accomplished four tasks,
              two of which involved building e-commerce websites. I developed
              these websites using React and Redux, gaining valuable experience
              in best practices for building React applications. Additionally, I
              learned how to work effectively from Figma designs and leverage
              project management platforms like Slack and GitHub.
            </p>
          </div>
        </div>
      </section>
      <section
        id="projects"
        className="px-10 bg-[url()] text-[2.6rem] flex flex-col gap-7"
      >
        <h1 className=" text-center pt-20 text-[3rem] font-[800]">
          My Projects
        </h1>
        ...
        <div className="flex  py-8 font-Poppins  gap-5 justify-center text-[8rem] flex-wrap">
          {projects.map((project, index) => {
            return (
              <div
                className="px-7  flex flex-col  md:px-96 gap-6 p-10 shadow-sm "
                key={project.link}
              >
      ...
      <section className="px-10 my-8  text-[2.6rem] flex flex-col gap-7">
        ...
        <div className="px-10 flex flex-col gap-10">
          <div className="flex gap-4">
            <a href="https://www.linkedin.com/in/eyob2m">
              {" "}
              <div className="border  border-black p-4 rounded-xl">
                <RiLinkedinLine />
              </div>
            </a>
            <a href="https://www.github.com/eyob2m">
              {" "}
              <div className="border  border-black p-4 rounded-xl">
                <RiGithubLine />
              </div>
            </a>
            <a href="https://www.facebook.com/eyob2m">
              {" "}
              <div className="border  border-black p-4 rounded-xl">
                <RiFacebookLine />
              </div>
